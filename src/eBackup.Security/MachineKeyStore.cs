...
/// Создание ключа — привилегированная операция (на реальном %ProgramData% строгий DACL ставит
/// elevated-провижининг на S7); здесь это аддитивная, дормантная машинерия — в живой путь не
/// вшита (см. план эпика).
/// </summary>
