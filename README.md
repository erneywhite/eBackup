...
> 🎉 **Версия 0.1.0** — первый публичный релиз. Всё описанное ниже работает;
> впереди финальный логотип и новые модули.
...
<!-- TODO: добавить скриншоты интерфейса (Обзор, Бэкап, Хранилища, История).
     Картинки кладём в docs/screenshots/ и вставляем сюда после финального лого. -->

> Скриншоты появятся здесь в ближайшем обновлении README.
...
Сделано: ✅ установщик одним exe (self-contained), ✅ релиз
[v0.1.0](https://github.com/erneywhite/eBackup/releases/latest), ✅ автообновление.

Впереди:
- Финальный логотип и скриншоты в README → версия 1.0.0 (сейчас логотип временный)
- Динамические DLL-плагины (с моделью доверия и подписями)
- Бэкап ключей реестра Windows; новые модули приложений
- English UI; интеграция с Планировщиком Windows
