...
> 🎉 **Версия 1.0.0** — стабильный релиз. Всё описанное ниже работает;
> впереди новые модули (игры и серверы) и DLL-плагины.
...
[v1.0.0](https://github.com/erneywhite/eBackup/releases/latest), ✅ автообновление,
✅ финальный логотип.

Впереди:
- Новые модули — приложения и игры (Minecraft, Vintage Story и др.), игровые серверы
