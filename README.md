...
- **Установщик** одним exe (self-contained — .NET у пользователя не нужен) — следующий шаг
- **Релиз v0.1** на GitHub Releases
- Финальный логотип (рисуется художницей; сейчас временный)
